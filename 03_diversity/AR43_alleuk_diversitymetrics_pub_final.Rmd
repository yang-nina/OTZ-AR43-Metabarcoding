...
prot_alpha_div <- prot_list %>% 
  ...
  dplyr::select(sample, obs, shannon, invsimpson, deployment, diel, depth, uniqueID, depth_group)
...
save(prot_mean_sd, prot_mean_sd_shannon, prot_mean_sd_invsimp, met_mean_sd, met_mean_sd_shannon, met_mean_sd_invsimp, fish_mean_sd, fish_mean_sd_shannon, fish_mean_sd_invsimp, file = "./alleuk_mean_sd_rarefaction_stats.RData")
...
#save(prot_taxa, met_taxa_order2, fish_taxa_order, file = "./psmelt_tables_for networks.RData")
...
print((sum_abun_unassigned / sum_seqs) * 100) # this is the total % of the dataset that was unassigned 18.42325%
...
print((sum_abun_assigned_met / sum_seqs) * 100) # this is the total % of the dataset that got assigned 18.07%
...
dim(unassigned_check_vert) # 505 x 4
...
print((sum_abun_unassigned / sum_seqs) * 100) # this is the total % of the dataset that was unassigned 12.88%
...
print((sum_abun_assigned / sum_seqs) * 100) # this is the total % of the dataset that got assigned 11.93%
...
```{r prot-top-asv, eval = TRUE, message = FALSE, warning = FALSE}
...
ggsave("./plots-final/test_evenness_prot_panel.pdf", height = 120, width = 180, units = "mm", dpi=300)
...
ggsave("./plots-final/alleuk_fish_dvm_pub.pdf", height = 8, width = 6, units = "in", dpi=300)
